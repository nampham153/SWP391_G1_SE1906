...
<div class="mb-3">
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="status" id="statusActive" value="1"
               <%= (c == null || Boolean.TRUE.equals(c.getStatus())) ? "checked" : "" %>>
        <label class="form-check-label" for="statusActive">Kích hoạt</label>
    </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="status" id="statusInactive" value="0"
               <%= (c != null && Boolean.FALSE.equals(c.getStatus())) ? "checked" : "" %>>
        ...
        <a href="<%= request.getContextPath() %>/staff/customer" class="btn btn-secondary">Quay lại</a>
    </form>
</div>
